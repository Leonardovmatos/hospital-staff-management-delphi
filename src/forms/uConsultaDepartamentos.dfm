object FrmConsultaDepartamentos: TFrmConsultaDepartamentos
  Left = 0
  Top = 0
  ...
  object pnlTopo: TPanel
    ...
    object pnlPesquisaCanto: TPanel
      Left = 596
      Top = 1
      Width = 152
      Height = 63
  ...
  object grdConsultaDepartamentos: TDBGrid
    Left = 0
    Top = 65
    Width = 749
    Height = 236
    Align = alClient
    DataSource = dsConsultaDepartamentos
  ...
  object pnlTotalRegistros: TPanel
    ...
    object pnlToTheRight: TPanel
      ...
      TabOrder = 0
      ExplicitLeft = 576
      object lblRegistrosTotal: TLabel
        Left = 11
        Top = 10
        Width = 94
        Height = 13
  ...
  object dsConsultaDepartamentos: TDataSource
    DataSet = qryConsultaDepartamentos
    Left = 105
    Top = 154
  end
  object qryConsultaDepartamentos: TFDQuery
    AfterOpen = qryConsultaDepartamentosAfterOpen
