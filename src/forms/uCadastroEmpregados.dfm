object FrmCadastroEmpregado: TFrmCadastroEmpregado
  Left = 0
  Top = 0
  ...
  object pnlTopo: TPanel
    ...
    object lblCodigoFuncao: TLabel
      Left = 34
      Top = 56
      Width = 84
      Height = 15
      Caption = 'Codigo Funcao:'
    end
