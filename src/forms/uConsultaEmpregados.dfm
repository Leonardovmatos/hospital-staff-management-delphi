object frmConsultaEmpregados: TfrmConsultaEmpregados
  Left = 0
  Top = 0
  Caption = 'Consulta Empregados'
  ClientHeight = 441
  ClientWidth = 767
  Color = clBtnFace
  ...
  object pnlTopo: TPanel
    ...
    object cbbDepartamento: TDBLookupComboBox
      Left = 107
      Top = 53
      Width = 145
      Height = 23
      ...
      ListSource = dsDepartamentosFiltro
      TabOrder = 2
    end
  ...
  object pnlGrid: TPanel
    ...
    ExplicitWidth = 185
    ExplicitHeight = 41
    object grdConsultaEmpregados: TDBGrid
      Left = 1
      Top = 1
      Width = 765
      Height = 256
      Align = alClient
      DataSource = dsConsultaEmpregados
      TabOrder = 0
  ...
  object dsDepartamentosFiltro: TDataSource
    DataSet = qryDepartamentosFiltro
    Left = 64
  end
  object qryDepartamentosFiltro: TFDQuery
    Connection = dmConnection.FDConnection
    Left = 200
  end
  object dsConsultaEmpregados: TDataSource
    DataSet = qryConsultaEmpregados
    Left = 72
    Top = 193
  end
  object qryConsultaEmpregados: TFDQuery
    AfterOpen = qryConsultaEmpregadosAfterOpen
    Connection = dmConnection.FDConnection
    Left = 72
    Top = 257
  end
